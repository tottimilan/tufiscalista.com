    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container-premium relative z-10 pt-32 pb-20 md:pt-40 md:pb-32">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Badge variant="gold">
              Asesoría fiscal boutique para autónomos y pymes
            </Badge>
          </motion.div>
          ...
          <motion.h1
            ...
            className="mt-8 font-serif text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold leading-[1.1] tracking-tight"
          >
            Máximo 20 clientes.{" "}
